...
public class DockerConnectMySQL {
   ...
   static final String USER = "mzarajczyk";
   ...
   String sql;
    ...
    try{        
      System.out.println("Check if table in base exist");
        ...
        sql = "INSERT INTO Persons (PersonID, LastName, FirstName, Address, City) VALUES (1, 'Kowalik', 'Zbigniew', 'Narutowicza','Lublin'), (2, 'Kowal', 'Marian', 'Zielona','Lublin'), (3, 'Kowalik', 'Anna', 'Andrzejewska','Andrzejow')";
        stmt.executeUpdate(sql);   
        stmt = null;
